document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function getFieldLabel(field) {
      ...
      return field.getAttribute('placeholder') || field.getAttribute('name') || 'Field';
    }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לוי דויד משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9a2d439f-7d3d-4b31-bd14-582490331c09',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9a2d439f-7d3d-4b31-bd14-582490331c09';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9a2d439f-7d3d-4b31-bd14-582490331c09';
